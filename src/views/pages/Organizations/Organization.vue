<template>
  <div>
    <b-row class="justify-content-center m-5">
      <b-col col="12" lg="2" class="zoom-box my-3">
        <a href="https://tis.dasta.or.th/stisdasta/" target="_blank">
          <img
            src="../../../assets/images/org1.jpg"
            width="200"
            height="100%"/></a
      ></b-col>
      <b-col col="12" lg="2" class="zoom-box my-3">
